...
builder.Services.AddDbContext<BODYTRAININGDbContext>(options => {
    // Đọc chuỗi kết nối
...
builder.Services.AddIdentity<User, IdentityRole>()
        .AddEntityFrameworkStores<BODYTRAININGDbContext>()
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Swagger BODYTRANING Solution", Version = "v1" });
